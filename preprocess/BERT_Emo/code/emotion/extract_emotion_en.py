...
import nltk
tqdm(nltk.download('vader_lexicon')) # 需要先下载
import re
...
lexicon_categories, lexicon_terms2arr = joblib.load(
    '../../resources/English/NRC/preprocess/preprocess-lexicon.pkl') # 需要运行生成preprocess-lexicon.pkl文件
...
intensity_categories, intensity_terms2arr = joblib.load(
    '../../resources/English/NRC/preprocess/preprocess-intensity.pkl')# 需要运行生成preprocess-intensity.pkl文件
